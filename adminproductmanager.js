...
function loadProducts() {
    ...
    /*
       ...
       Because global window properties are available
       as variables in the browser, volticaProducts
       remains compatible here.
    */
...
function buildProductsJS() {
    ...
    /*
       ...
       This keeps the database accessible to every page
       that loads products.js.
    */
...
function createProductBlock(product) {
    ...
    */
    ...
    /*
       Indent JSON so the generated database remains
       clean and easy to read/edit manually.
    */
    ...
    return `    /* =========================================================
       Product name : ${sanitizeProductHeader(
           product.name
       )}
       ========================================================= */
...
/* =========================================================
   PRODUCT HEADER SANITIZER
   ========================================================= */

function sanitizeProductHeader(value) {
